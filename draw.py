def estuary(c, options = {}):
    palette = {
        'background': '#22221B',
        'background-alt': '#22221B', 
        'background-attention': '#302F27',
        'border': '#22221B',
        'current-line': '#5F5E4E',
        'selection': '#5F5E4E',
        'foreground': '#F4F3EC',
...
def estuaryLight(c, options = {}):
    palette = {
        'foreground': '#22221B',
        'foreground-alt': '#22221B', 
        'foreground-attention': '#302F27',
        'border': '#22221B',
        'current-line': '#5F5E4E',
        'selection': '#5F5E4E',
        'background': '#F4F3EC',
        'background-alt': '#e0e0e0',
        'background-attention': '#ffffff',
        'comment': '#36a166',
        'cyan': '#5B9D48',
        'green': '#7D9726',
        'orange': '#AE7313',
